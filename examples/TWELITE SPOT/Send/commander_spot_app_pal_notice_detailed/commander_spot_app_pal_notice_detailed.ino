// Commander example for TWELITE SPOT: Send 0x90 detailed command to App_PAL (NOTICE)
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("Commander example for TWELITE SPOT: App_PAL (NOTICE), Detailed");
