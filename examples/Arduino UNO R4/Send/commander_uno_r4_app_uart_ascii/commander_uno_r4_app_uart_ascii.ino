// Commander example for TWELITE with Arduino UNO R4: Send command to App_Uart (Mode A)
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("Commander example for TWELITE with Arduino UNO R4: App_Uart (Mode A)");
