// Commander example for TWELITE with Arduino UNO R4: Send fully-manually-created 0x80 command to App_Twelite
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("Commander example for TWELITE with Arduino UNO R4: App_Twelite, fully manually");
