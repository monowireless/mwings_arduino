// Monitor example for TWELITE with Arduino UNO R4: Receive data from App_ARIA (ARIA Mode)
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("Monitor example for TWELITE with Arduino UNO R4: App_ARIA (ARIA Mode)");
